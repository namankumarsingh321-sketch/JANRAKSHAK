...
## 1. Request Parameters  
    ...
    Name: nh7_uttrakhand_dem  

    Date Completed: 2026-09-11T13:21:02.630700  

    ID: f981faec-90a6-479a-92df-3fe16ae4a42b  
...
- nh7-uttrakhand-dem-SRTMGL1-NC-003-metadata.xml
- nh7-uttrakhand-dem-granule-list.txt
- nh7-uttrakhand-dem-request.json
...
Total Size of Extracted Data Files: 37.37 MB  
...
`<ProductShortName>.<Version>_<LayerName>_<Year><Month><Date>T<Hour><Minute><Second>_<AppEEARSFeatureID>.<FileFormat>`  

### Example output file name (.tif)  

    MOD13Q1.061__250m_16_days_NDVI_20250712T000000_aid0002.tif    
...
- NASA JPL. (2013). NASA Shuttle Radar Topography Mission Global 1 arc second NetCDF. NASA Land Processes Distributed Active Archive Center. https://doi.org/10.5067/MEASURES/SRTM/SRTMGL1_NC.003. Accessed September 11, 2026.

## 10. Software Citation  

AppEEARS Team. (2026). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 3.128. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed September 11, 2026. https://appeears.earthdatacloud.nasa.gov
